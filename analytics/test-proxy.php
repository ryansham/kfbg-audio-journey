...
check('香港 8/26 08:30（UTC 00:30）', $at('2026-08-26T00:30:00Z'), '2026-08-24');
check('香港 8/26 23:59（UTC 15:59）', $at('2026-08-26T15:59:59Z'), '2026-08-24');
// 🔴 UTC 16:00 開始，香港已經踏入下一日。用 UTC 判斷「今天」的話這兩格會慢一日，
//    而這八個鐘（香港 00:00–08:00）每天都會出現 —— 同事一早開報告就中招。
check('香港 8/27 00:00（UTC 16:00）', $at('2026-08-26T16:00:00Z'), '2026-08-25');
check('香港 8/27 07:59（UTC 23:59）', $at('2026-08-26T23:59:59Z'), '2026-08-25');
// 跨月、跨年一樣要對
check('跨月：香港 9/1 → 8/30',        $at('2026-08-31T16:00:00Z'), '2026-08-30');
check('跨年：香港 2027/1/1 → 12/30',  $at('2026-12-31T16:00:00Z'), '2026-12-30');
